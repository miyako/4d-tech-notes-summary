# Tech Note: Integrating the YUI DataTable with the 4D Ajax Framework Data Bridge

## Overview
The flexibility of the 4D Ajax Framework allows for it to interact and be integrated alongside other Ajax frameworks and API’s. This Technical Note will cover integrating the YUI DataTable with a 4D Ajax Framework web application using the Data Bridge commands. A sample database is included for both 4D 2004 and 4D v11 SQL.

## Key Points
- Published March 19, 2008 as Technical Note 08-10.
- Targets 4D Web 2.0 Pack v11 on Mac &amp; Win.
